...
import { addItemsTocart } from '../../redux/action/Cart';
const ProductDetails = () => {
    ...
    const {productdetails,loading} = useSelector(state => state.pdetail)
                ...
                <div id="product-carousel" className="carousel slide" data-ride="carousel">
                    <div className="carousel-inner bg-light">
                        <div className="carousel-item active">
                            <img className="w-100 h-100" src={productdetails?.image?.url} alt=""/>
                        </div>
